...
function encodeToRot13(str) {
  ...
  charArr.forEach((el) => {
    if ((el.charCodeAt(0) >= 65 && el.charCodeAt(0) <= 90)) {
      localString = (el.charCodeAt(0) + 13 > 90
        ? el.charCodeAt(0) - 13
        : el.charCodeAt(0) + 13);
    } else if ((el.charCodeAt(0) >= 97 && el.charCodeAt(0) <= 122)) {
      localString = (el.charCodeAt(0) + 13 > 122
        ? el.charCodeAt(0) - 13
        : el.charCodeAt(0) + 13);
    } else localString = el.charCodeAt(0);

    answer += String.fromCharCode(localString);
  });
  return answer;
}
